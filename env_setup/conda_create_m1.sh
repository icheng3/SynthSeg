...
MY_CONDA_ENV_NAME="synthseg"                 # name of the conda environment
MY_CONDA_ENV_CFG_FILE="env_setup/synthseg-m1.yml" # name/path of the conda environment config file
